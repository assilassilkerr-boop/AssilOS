        ;
        ; AssilOS, an operating system based on BootOS in 512 bytes
        ;
        ; by Assil Kerr
        ;
        ...
        ; What is AssilOS:
        ; 
        ;   AssilOS is a monolithic operating system based BootOS on that fits in
        ...
        ;
        ;   AssilOS uses tracks from 0 to 32, side 0, sector 1.
        ;
        ...
        ;   $
        ;
        ; AssilOS programs: (Oh yes! we have software support)
        ;
...
osbase: equ 0x7a00      ; AssilOS location
...
start:
        ...
        cld             ; Clear D flag.
        mov si,boot     ; Copy AssilOS boot sector...
...
print_then_restart:
        call output_string
        int int_restart ; Restart AssilOS

        ;
        ; Warm start of AssilOS
        ;
restart:
        cld             ; Clear D flag.
...
format_command:
        ...
        mov cx,sector_size
        call write_zero_dir
        mov bx,osbase   ; Copy AssilOS onto first sector
        dec cx
        jmp short disk
