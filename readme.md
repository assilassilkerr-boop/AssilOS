...
- NASM assembler
- QEMU emulator (or real hardware for advanced users, Note for newer computers: If your machine uses UEFI, make sure to disable Secure Boot and enable CSM (Legacy Boot) in your BIOS settings, otherwise AssilOS will not boot. 🛠️ Build Instructions)
- Make (optional)
